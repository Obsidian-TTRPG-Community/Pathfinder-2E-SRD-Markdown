...
When you cast [fireball](../spells/fireball.md), you can modify its effects, decreasing the base damage to `5d6` and causing it to deal 2 [persistent fire damage](../../Rules/conditions.md#Persistent%20Damage) to creatures that fail their save, doubled as normal on a critical failure. If you do, replace its heightened entry with the following.
