...
> [!success-degree] 
> - **Critical Success** The spirit is particularly cooperative, and even if it has strong reasons to deceive you, it takes a –2 circumstance penalty to its [Deception](../../skills.md#Deception) checks.
