...
- **Prerequisites**: trained in [Acrobatics](../../skills.md#Acrobatics) or [Athletics](../../../compendium/skills.md#Athletics), [Firebrand Braggart Dedication](../../../compendium/feats/firebrand-braggart-dedication-locg.md)
- **Activity** Two-Action
