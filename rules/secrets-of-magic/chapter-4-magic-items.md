...
You still need to [Craft](rules/actions/craft.md) the staff. If you're not good at [Crafting](compendium/skills.md#Crafting), you can have somebody use the [Craft](rules/actions/craft.md) activity for you, but you must be present the whole time. Since the creation of a custom staff is [rare](rules/traits/rare.md), you and the GM might decide to have a special quest for esoteric ingredients and methods as part of the story.
