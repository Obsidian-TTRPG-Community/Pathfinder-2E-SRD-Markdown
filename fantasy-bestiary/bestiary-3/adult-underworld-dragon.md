...
abilities_mid:
  ...
  - name: "Sweltering Heat"
    desc: " ([[arcane]], [[aura]], [[evocation]], [[fire]]);  10 feet. Each creature that ends its turn in the aura must succeed at a DC 28 Fortitude saving throw or become [[rules/conditions.md#Fatigued|fatigued]] while it remains in the aura."
abilities_bot:
  ...
  - name: "Breath Weapon"
    desc: "⬺ ([[arcane]], [[evocation]], [[fire]]);  The dragon breathes a blast of fire that explodes in a 25-foot burst within 50 feet, dealing 10d6 (10d6) fire damage (DC 30 basic Reflex save). Creatures that fail the save also take 2d6 (2d6) [[rules/conditions.md#Persistent%20Damage|persistent fire damage]]. The dragon can't use Breath Weapon again for 1d4 (1d4) rounds."
  - name: "Coiling Frenzy"
...
spellcasting:
  - name: "Arcane Innate Spells"
    desc: "DC 30, attack +24; __Cantrips (4th)__ [[detect-magic|detect magic]]; __4th__ [[continual-flame|continual flame]], [[wall-of-fire|wall of fire]];"
