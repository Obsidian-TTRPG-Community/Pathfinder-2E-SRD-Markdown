...
abilities_bot:
  ...
  - name: "Drain Blood"
    desc: "⬻ ([[necromancy]], [[occult]]); __Requirements__ A [[rules/conditions.md#Grabbed|grabbed]], [[rules/conditions.md#Paralyzed|paralyzed]], [[rules/conditions.md#Restrained|restrained]], [[rules/conditions.md#Unconscious|unconscious]], or willing creature is within the blood hag's reach  __Effect__  The hag sinks her fangs into the creature to drink its blood. This requires a successful [[Athletics]] check against the victim's Fortitude DC if the victim is [[rules/conditions.md#Grabbed|grabbed]] and is automatic for any of the other conditions. The victim becomes [[rules/conditions.md#Drained|drained 1]]. The hag regains 15 Hit Points, gaining any excess HP as temporary Hit Points that last for 1 hour. Drinking blood from a creature that's already [[rules/conditions.md#Drained|drained]] doesn't restore any Hit Points to the hag but increases the victim's [[rules/conditions.md#Drained|drained]] value by 1, killing the victim when it reaches [[rules/conditions.md#Drained|drained 5]]. A victim's [[rules/conditions.md#Drained|drained]] condition decreases by 1 per week. A blood transfusion, which requires a successful DC 20 [[Medicine]] check and sufficient blood or a blood donor, reduces the [[rules/conditions.md#Drained|drained]] condition by 1 after 10 minutes."
