...
abilities_bot:
  ...
  - name: "Whisper Earworm"
    desc: "⬻ ([[divination]], [[divine]], [[emotion]], [[mental]]);  The deimavigga whispers a terrifying multiversal truth to one adjacent creature, shaking its faith in reality and divinity. The target must attempt a DC 43 Will save. Celestials and fiends gain a +2 status bonus to this save.\n__Critical Success__ The target is unaffected and temporarily immune to Whisper Earworm for 24 hours.\n__Success__ The target is unaffected.\n__Failure__ The next time the target rests, it ruminates on the deimavigga's words instead of sleeping or otherwise resting and awakens [[rules/conditions.md#Fatigued|fatigued]]. The target also becomes [[rules/conditions.md#Drained|drained 1]] and [[rules/conditions.md#Stupefied|stupefied 1]] until it's no longer [[rules/conditions.md#Fatigued|fatigued]].\n__Critical Failure__ As failure, but [[rules/conditions.md#Drained|drained 2]]. After this rest, the target must attempt another DC 43 Will save. On a failure, the target becomes [[rules/conditions.md#Stupefied|stupefied 2]] and takes a –4 status penalty to Will saves against effects from evil creatures. These effects last until the target unlearns the truth spoken by the deimavigga, requiring a [[modify-memory|modify memory]] spell, other means of modifying their memory, or powerful magic such as [[wish]]."
...
spellcasting:
  - name: "Divine Innate Spells"
    desc: "DC 42, attack +34; __3rd__ [[dream-message|dream message]] (at will); __4th__ [[dimension-door|dimension door]] (at will); __7th__ [[dimension-door|dimension door]], [[scrying]], [[touch-of-idiocy|touch of idiocy]] (at will), [[veil]], [[warp-mind|warp mind]]; __9th__ [[divine-decree|divine decree]], [[dominate]], [[illusory-scene|illusory scene]] (at will);"
