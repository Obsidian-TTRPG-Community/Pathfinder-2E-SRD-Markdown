...
abilities_mid:
  - name: "Feign Death"
    desc: "⬲ __Trigger__ The opossum is reduced below 70 HP __Effect__  The khravgodon collapses. It is [[rules/conditions.md#Flat-Footed|flat-footed]] and can use actions that require only its mind, but any other action ends the ruse. A successful DC 18 [[compendium/skills.md#Perception|Perception]] check to [[Seek]] or [[compendium/skills.md#Medicine|Medicine]] check to [[Recall-Knowledge|Recall Knowledge]] is required to determine that the animal is not, in fact, dead."
