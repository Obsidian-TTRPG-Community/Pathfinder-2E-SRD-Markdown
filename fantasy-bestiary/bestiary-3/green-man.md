...
abilities_top:
  - name: "Green Tongue"
    desc: "  A green man can communicate with plants, with the effects of speak with plants, and can use [[compendium/skills.md#Diplomacy|Diplomacy]] to [[Make-an-Impression|Make an Impression]] on plants and [[Request]] things from plants."
  - name: "Plantsense"
...
abilities_mid:
  ...
  - name: "Green Caress"
    desc: " ([[aura]], [[incapacitation]], [[plant]], [[primal]], [[transmutation]]);  60 feet. Living creatures in the area other than plants slowly transform into non-creature plants. The green man can exclude creatures from this effect, but they must be aware of a creature's presence and location to do so. A non-plant creature in the area must attempt a DC 45 Fortitude save immediately before the start of its turn.\n__Critical Success__ The creature is unaffected, or if it is [[rules/conditions.md#Slowed|slowed]] by green caress, it reduces its [[rules/conditions.md#Slowed|slowed]] value by 2.\n__Success__ The creature is unaffected, or if it is [[rules/conditions.md#Slowed|slowed]] by green caress, it reduces its [[rules/conditions.md#Slowed|slowed]] value by 1.\n__Failure__ The creature becomes [[rules/conditions.md#Slowed|slowed 1]], or if it was already [[rules/conditions.md#Slowed|slowed]] by green caress, increases the [[rules/conditions.md#Slowed|slowed]] value by 1, as their body transforms more and more into a non-creature plant. If the creature ever becomes [[rules/conditions.md#Slowed|slowed]] to the point they have no actions left for their turn, they become an inanimate plant, a condition that can only be reversed by primal phenomenon or similarly powerful magic.\n__Critical Failure__ As failure, except the creature becomes [[rules/conditions.md#Slowed|slowed 2]] (or increases the condition value by 2)."
  - name: "Root In Place"
...
abilities_bot:
  ...
  - name: "Green Grab"
    desc: "  A green man can use their [[Improved-Grab|Improved Grab]] action against a creature of any size."
  - name: "Green Rituals"
...
spellcasting:
  - name: "Primal Innate Spells"
    desc: "DC 48; __Cantrips (10th)__ [[detect-magic|detect magic]], [[read-aura|read aura]]; __8th__ [[air-walk|air walk]], [[freedom-of-movement|freedom of movement]]; __9th__ [[energy-aegis|energy aegis]]; __10th__ [[heal]] (3), [[regenerate]] (3), [[tree-stride|tree stride]] (at will), [[true-seeing|true seeing]], [[primal-phenomenon|primal phenomenon]] (3);"
