...
abilities_bot:
  ...
  - name: "Suspend Soul"
    desc: "⬻ ([[arcane]], [[necromancy]]);  The quintessivore suspends the life processes of a [[rules/conditions.md#Dying|dying]] creature within 15 feet of it. The creature can't decrease or increase its HP or [[rules/conditions.md#Dying|dying]] value for 10 minutes. The creature can attempt a DC 29 Will save to avoid this effect. If the creature receives magical healing, it can attempt a new save, ending the effect and being healed normally on a success. The effect ends if the quintessivore uses Suspend Soul again."
  - name: "Tattered Soul"
    desc: "  A creature hit by the quintessivore's blade-leg [[Strike]] must succeed at a DC 29 Fortitude save or become [[rules/conditions.md#Drained|drained 1]] ([[rules/conditions.md#Drained|drained 2]] on a critical failure). If the creature is already [[rules/conditions.md#Drained|drained]], it's immune to this effect."
...
spellcasting:
  - name: "Arcane Prepared Spells"
    desc: "DC 29, attack +21; __Cantrips (5th)__ [[daze]], [[detect-magic|detect magic]], [[mage-hand|mage hand]], [[ray-of-frost|ray of frost]], [[read-aura|read aura]]; __1st__ [[feather-fall|feather fall]], [[fleet-step|fleet step]], [[ray-of-enfeeblement|ray of enfeeblement]]; __2nd__ [[comprehend-language|comprehend language]], [[see-invisibility|see invisibility]], [[web]]; __3rd__ [[slow]], [[vampiric-touch|vampiric touch]] (2); __4th__ [[clairvoyance]], [[enervation]] (2); __5th__ [[black-tentacles|black tentacles]], [[grim-tendrils|grim tendrils]], [[passwall]];"
