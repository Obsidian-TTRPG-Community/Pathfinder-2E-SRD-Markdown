...
abilities_mid:
  - name: "Head Bowl"
    desc: "  The depression atop a kappa's head is filled with water. Spilling, evaporating, or otherwise removing all of the water from the top of a kappa's head reduces all their Speeds to 5 feet until the basin is again filled with water. A kappa who becomes [[rules/conditions.md#Prone|prone]] must succeed at a DC 15 Reflex save or spill their water, and a kappa who becomes [[rules/conditions.md#Unconscious|unconscious]] automatically spills their water. If a kappa is grappled, [[rules/conditions.md#Restrained|restrained]], or [[rules/conditions.md#Stunned|stunned]], another creature can attempt to spill the water from their bowl by spending a single action, which has the [[attack]] and [[manipulate]] traits, to attempt an [[compendium/skills.md#Athletics|Athletics]] check against the kappa's Fortitude DC. On a success, the creature spills the kappa's water."
abilities_bot:
  - name: "Pull Arm"
