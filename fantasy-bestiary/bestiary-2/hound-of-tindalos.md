...
abilities_mid:
  - name: "Otherworldly Mind"
    desc: " ([[mental]]);  Whenever a creature targets the hound with a [[mental]] effect, that creature takes 4d6 (4d6) mental damage (DC 25 basic Will save). On a critical failure, it also becomes [[rules/conditions.md#Confused|confused]] for 1d4 (1d4) rounds."
  - name: "Ripping Gaze"
...
spellcasting:
  - name: "Occult Innate Spells"
    desc: "DC 21; __2nd__ [[invisibility]] self only; __3rd__ [[haste]], [[slow]]; __4th__ [[dimensional-anchor|dimensional anchor]]; __8th__ [[discern-location|discern location]];"
