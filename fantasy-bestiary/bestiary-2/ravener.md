...
abilities_top:
  - name: "Smoke Vision"
    desc: "  Smoke doesn't impair an ancient red ravener's vision; it ignores the [[rules/conditions.md#Concealed|concealed]] condition from smoke."
abilities_mid:
  - name: "Cowering Fear"
...
abilities_bot:
  ...
  - name: "Ravenous Breath Weapon"
    desc: "⬺ ([[arcane]], [[evocation]], [[fire]]);  The ravener breathes a blast of flame that deals 20d6 (20d6) fire damage plus 4d6 (4d6) [[rules/conditions.md#Persistent%20Damage|persistent negative damage]] (DC 44 basic Reflex save). A creature that fails its save is also [[rules/conditions.md#Drained|drained 1]] (or [[rules/conditions.md#Drained|drained 2]] on a critical failure). If a creature is [[rules/conditions.md#Drained|drained]] by the ravener's Ravenous Breath Weapon, the ravener's soul ward gains 5 HP. The ravener can't use Breath Weapon again for 1d4 (1d4) rounds."
  - name: "Vicious Criticals"
    desc: "  The ravener treats an attack roll as a critical hit on a roll of 19 or 20, as long as the attack roll was a success. Additionally, whenever the ravener makes a critical hit with one of their [[Strike|Strikes]], the target must succeed on a Fortitude save or gain the [[rules/conditions.md#Drained|drained 1]] condition. If the target already has a [[rules/conditions.md#Drained|drained]] value of greater than 0, their [[rules/conditions.md#Drained|drained]] value instead increases by 1, to a maximum of [[rules/conditions.md#Drained|drained 4]]. Whenever the ravener applies drain to a creature in this way, their soul ward gains 5 Hit Points."
