...
abilities_mid:
  - name: "Aura of Sobs"
    desc: " ([[auditory]], [[aura]], [[emotion]], [[enchantment]], [[mental]], [[occult]]);  10 feet. An attic whisperer enshrouds itself in a tapestry of stolen voices. Each living creature that enters or starts their turn in the aura must succeed at a DC 19 Will save or the unnerving, bitter sobs render them distraught and they become [[rules/conditions.md#Stupefied|stupefied 1]] for as long as they remain within the aura. A creature that succeeds is temporarily immune for 1 hour. The attic whisperer can activate or deactivate the aura with a single free action, which has the [[concentrate]] trait."
...
abilities_bot:
  - name: "Steal Breath"
    desc: " ([[curse]], [[incapacitation]], [[necromancy]], [[occult]]);  The attic whisperer siphons the breath from living creatures, sapping their strength. A living creature hit by a jaws [[Strike]] must attempt a DC 21 Fortitude save.\n__Critical Success__ The target is unaffected.\n__Success__ The target is [[rules/conditions.md#Enfeebled|enfeebled 1]] for 1 round.\n__Failure__ The target is [[rules/conditions.md#Enfeebled|enfeebled 1]] for 24 hours and [[rules/conditions.md#Fatigued|fatigued]].\n__Critical Failure__ The target is [[rules/conditions.md#Enfeebled|enfeebled 1]] for 24 hours, is [[rules/conditions.md#Fatigued|fatigued]], and falls [[rules/conditions.md#Unconscious|unconscious]]."
  - name: "Steal Voice"
