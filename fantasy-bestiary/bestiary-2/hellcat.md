...
abilities_mid:
  - name: "Fade into the Light"
    desc: "⬲ ([[divine]], [[illusion]]); __Trigger__ The hellcat begins its turn in bright light __Effect__  The hellcat becomes [[rules/conditions.md#Invisible|invisible]] until its no longer in bright light. If the hellcat uses a [[rules/conditions.md#Hostile|hostile]] action, the invisibility ends after that [[rules/conditions.md#Hostile|hostile]] action is completed."
abilities_bot:
  - name: "Fearful Attack"
    desc: "  The hellcat deals an additional 1d6 (1d6) precision damage to [[rules/conditions.md#Frightened|frightened]] creatures."
