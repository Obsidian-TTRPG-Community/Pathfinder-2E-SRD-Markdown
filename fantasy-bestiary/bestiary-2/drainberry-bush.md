...
abilities_bot:
  ...
  - name: "Drain Blood"
    desc: "⬻ __Requirements__ The drainberry bush has at least one living creature [[rules/conditions.md#Grabbed|grabbed]] with one of its vines  __Effect__  The bush's hollow thorns siphon blood from creatures it has [[rules/conditions.md#Grabbed|grabbed]]. Each creature must succeed at a DC 25 Fortitude save or take 2d8+10 (2d8+10) damage and become [[rules/conditions.md#Drained|drained 1]] (double damage and [[rules/conditions.md#Drained|drained 2]] on a critical failure). For every creature damaged this way, a cluster of blood berries (see above) immediately grows along the bush's branches."
  - name: "Storm of Vines"
