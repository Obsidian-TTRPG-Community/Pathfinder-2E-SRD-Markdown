...
abilities_mid:
  - name: "Blinding Soul"
    desc: " ([[divine]], [[evocation]], [[light]], [[visual]]);  Whenever the star archon takes slashing damage, bright light pours from their wounds. Non-archons within 10 feet must attempt a DC 38 Fortitude save. On a failure, a creature is [[rules/conditions.md#Dazzled|dazzled]] for 1 round. On a critical failure, the creature is [[rules/conditions.md#Blinded|blinded]] for 1d4 (1d4) rounds instead. The creature is then temporarily immune for 1 round."
