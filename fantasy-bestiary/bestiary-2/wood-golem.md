...
abilities_mid:
  - name: "Golem Antimagic"
    desc: "  harmed by fire (4d8 (4d8), 2d6 (2d6) from areas or [[rules/conditions.md#Persistent%20Damage|persistent damage]]); healed by plant (area 2d6 (2d6) HP); [[rules/conditions.md#Slowed|slowed]] by earth."
  - name: "Vulnerable to Shape Wood"
    desc: "  A wood golem targeted by shape wood takes 2d8 (2d8) damage per spell level, with a basic Fortitude save against the caster's spell DC. On a critical failure, the golem is also [[rules/conditions.md#Immobilized|immobilized]] for 1d4 (1d4) rounds."
  - name: "Splinter"
