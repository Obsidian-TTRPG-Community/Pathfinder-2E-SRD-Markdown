...
abilities_bot:
  ...
  - name: "Crystallize Flesh"
    desc: "⭓ ([[primal]], [[transmutation]]); __Frequency__ once per day __Trigger__ The crystal dragon damages a creature made of flesh with a jaws [[Strike]] __Effect__  The dragon embeds transformative crystals in the creature's flesh. The creature must attempt a DC 37 Fortitude save.\n__Critical Success__ The target is unaffected.\n__Success__ The target is [[rules/conditions.md#Slowed|slowed 1]] for 1 round as portions of its flesh turn crystalline.\n__Failure__ The target is [[rules/conditions.md#Slowed|slowed 1]] and must attempt a Fortitude save at the end of each of its turns; this ongoing save has the [[incapacitation]] trait. On a failed save, the [[rules/conditions.md#Slowed|slowed]] condition value increases by 1 (or by 2 on a critical failure). A successful save reduces the [[rules/conditions.md#Slowed|slowed]] condition value by 1. A creature unable to act due to the [[rules/conditions.md#Slowed|slowed]] condition from Crystallize Flesh is [[rules/conditions.md#Petrified|petrified]] permanently, transforming into a crystalline statue. The effect ends if the creature is [[rules/conditions.md#Petrified|petrified]] or the [[rules/conditions.md#Slowed|slowed]] condition is removed.\n__Critical Failure__ As failure, but the target is initially [[rules/conditions.md#Slowed|slowed 2]]."
