...
abilities_bot:
  ...
  - name: "Swarming Beaks"
    desc: "⬻  The ravens' angry pecking deals 1d8 (1d8) piercing damage to each enemy in the swarm's space (DC 20 basic Reflex save). A creature that critically fails its save is [[rules/conditions.md#Blinded|blinded]] for 1d4 (1d4) rounds as the ravens focus their attacks on the target's vulnerable face."
