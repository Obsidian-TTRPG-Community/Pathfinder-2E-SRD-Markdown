...
abilities_mid:
  - name: "Confusing Gaze"
    desc: " ([[aura]], [[divine]], [[enchantment]], [[emotion]], [[incapacitation]], [[mental]], [[visual]]);  30 feet. A creature that ends its turn in the aura must attempt a DC 34 Will save. If it fails, it's [[rules/conditions.md#Confused|confused]] for 1 round (or 1d4 (1d4) rounds on a critical failure)."
...
abilities_bot:
  - name: "Aging Strikes"
    desc: "⬺ ([[divine]], [[necromancy]]);  The bythos make two fist [[Strike|Strikes]] against a single target. If both [[Strike|Strikes]] hit, the target attempts a DC 37 Fortitude save. Creatures that don't get weaker with age or don't age are immune (GM's discretion). If a creature becomes [[rules/conditions.md#Clumsy|clumsy 4]], [[rules/conditions.md#Drained|drained 4]], and [[rules/conditions.md#Enfeebled|enfeebled 4]] due to Aging [[Strike|Strikes]], it dies of old age.\n__Success__ The creature is unaffected.\n__Failure__ The creature becomes [[rules/conditions.md#Clumsy|clumsy 1]], [[rules/conditions.md#Drained|drained 1]], and [[rules/conditions.md#Enfeebled|enfeebled 1]], or increases each of these conditions by 1. This effect is cumulative with other aging strikes from bythoses, to a maximum of [[rules/conditions.md#Clumsy|clumsy 4]], [[rules/conditions.md#Drained|drained 4]], and [[rules/conditions.md#Enfeebled|enfeebled 4]].\n__Critical Failure__ As failure, but the creature becomes [[rules/conditions.md#Clumsy|clumsy 2]], [[rules/conditions.md#Drained|drained 2]], and [[rules/conditions.md#Enfeebled|enfeebled 2]], or increases these conditions by 2."
  - name: "Focused Gaze"
