...
abilities_bot:
  - name: "Pounce"
    desc: "⬻  The esobok [[Stride|Strides]] and then makes a [[Strike]]. If it began this action [[rules/conditions.md#Hidden|hidden]], it remains [[rules/conditions.md#Hidden|hidden]] until after the [[Strike]]."
  - name: "Spirit Touch"
  ...
  - name: "Wrench Spirit"
    desc: "⬻ ([[attack]], [[divine]], [[incapacitation]], [[necromancy]]);  Requirement A creature is [[rules/conditions.md#Grabbed|grabbed]] by the esobok's jaws; The esobok releases the target from the Grab but wrenches its spirit free as it does so. The creature must attempt a DC 20 Will save. Creatures without souls (such as most constructs) and creatures whose bodies and souls are one (such as most celestials, fiends, and monitors) that roll a failure or critical failure on the save get a success instead.\n__Critical Success__ The creature is unaffected.\n__Success__ The target is [[rules/conditions.md#Stunned|stunned 1]].\n__Failure__ The esobok wrenches the target's soul from its body into its jaws. Mindless undead creatures of level 2 or lower are destroyed, other undead creatures are [[rules/conditions.md#Stunned|stunned]] for 1 round, and all other creatures are [[rules/conditions.md#Paralyzed|paralyzed]]. At the end of each of its turns, a creature [[rules/conditions.md#Paralyzed|paralyzed]] by this effect can attempt a new save to end the effect. The paralysis ends automatically if the esobok attempts a jaws [[Strike]] or speaks.\n__Critical Failure__ As failure, but as long as a creature is [[rules/conditions.md#Stunned|stunned]] or [[rules/conditions.md#Paralyzed|paralyzed]], it is also [[rules/conditions.md#Stupefied|stupefied 2]]."
