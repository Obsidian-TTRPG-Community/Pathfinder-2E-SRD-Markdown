...
abilities_bot:
  - name: "Bore into Brain"
    desc: "⬽ ([[manipulate]], [[mental]]);  The creeper bores dozens of tendrils into the brain of a Small, Medium, or Large humanoid creature that's [[rules/conditions.md#Unconscious|unconscious]], willing, or [[rules/conditions.md#Fascinated|fascinated]] by Spray Pollen, and within reach of the creeper's tendrils. The creature must succeed at a DC 18 Fortitude save or become [[rules/conditions.md#Stupefied|stupefied 1]] ([[rules/conditions.md#Stupefied|stupefied 2]] on a critical failure). Subsequent failed saves against Bore into Brain increase the [[rules/conditions.md#Stupefied|stupefied]] value. If the creature reaches [[rules/conditions.md#Stupefied|stupefied 5]], it is turned into a yellow musk thrall (see below). Boring into a creature's brain doesn't end fascination caused by Spray Pollen."
  - name: "Spray Pollen"
  ...
  - name: "Spray"
    desc: "  Pollen, it becomes temporarily immune for 24 hours.\n__Success__ The creature is unaffected.\n__Failure__ The creature is [[rules/conditions.md#Fascinated|fascinated]]. For as long as it is [[rules/conditions.md#Fascinated|fascinated]], it must spend each of its actions to move closer to the yellow musk creeper as expediently as possible, while avoiding obvious dangers. If the creature is adjacent to the yellow musk creeper, it stays still and doesn't act.\n__Critical Failure__ As failure, but the condition doesn't end automatically. The creature can attempt a new save at the end of each of its turns. On a success, the [[rules/conditions.md#Fascinated|fascinated]] condition and other effects end."
