...
abilities_mid:
  - name: "Deny Advantage"
    desc: "  The gang leader isn't [[rules/conditions.md#Flat-Footed|flat-footed]] to creatures of 7th level or lower that are [[rules/conditions.md#Hidden|hidden]], [[rules/conditions.md#Undetected|undetected]], flanking, or using surprise attack."
  - name: "Evasion"
...
abilities_bot:
  ...
  - name: "Gang Up"
    desc: "  Any enemy is [[rules/conditions.md#Flat-Footed|flat-footed]] against the gang leader's melee attacks due to flanking as long as the enemy is within melee reach of both the gang leader and one of the gang leader's allies."
  - name: "Quick Draw"
    desc: "⬻  The gang leader Interacts to draw a weapon, then [[Strike|Strikes]] with that weapon."
  - name: "Sneak Attack"
    desc: "  The gang leader deals an extra 2d6 (2d6) precision damage to [[rules/conditions.md#Flat-Footed|flat-footed]] creatures."
