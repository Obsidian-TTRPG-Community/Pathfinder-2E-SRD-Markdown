...
abilities_bot:
  - name: "Jaws"
    desc: "⬻ ([[attack]]); __Requirements__ The zombie has a creature [[rules/conditions.md#Grabbed|grabbed]] or [[rules/conditions.md#Restrained|restrained]].  __Effect__  The zombie makes a jaws unarmed melee [[Strike]] against the [[rules/conditions.md#Grabbed|grabbed]] or [[rules/conditions.md#Restrained|restrained]] creature with an attack modifier of +9 that deals 1d12+4 (1d12+4) piercing damage. A creature damaged by the jaws is exposed to zombie rot."
  - name: "Zombie Rot"
