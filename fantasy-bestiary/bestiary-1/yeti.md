...
abilities_mid:
  ...
  - name: "Vanish"
    desc: "⬲ __Trigger__ The yeti is [[rules/conditions.md#Hidden|hidden]] or [[rules/conditions.md#Undetected|undetected]] while not in combat, and a creature would observe it. __Effect__  The yeti [[Stride|Strides]] or Climbs up to half its Speed to a location where it can [[Hide]], then Hides. If its new [[Stealth]] check result meets or exceeds the triggering creature's [[Perception]] DC, the yeti remains [[rules/conditions.md#Hidden|hidden]]."
abilities_bot:
  - name: "Grisly Arrival"
