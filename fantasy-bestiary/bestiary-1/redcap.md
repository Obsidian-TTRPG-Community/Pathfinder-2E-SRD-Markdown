...
abilities_bot:
  ...
  - name: "Stomp"
    desc: "⬻  The redcap [[Stride|Strides]] up to half its Speed and makes a boot [[Strike]] at any point during that movement. If the boot [[Strike]] hits a [[rules/conditions.md#Prone|prone]] creature, it deals an extra 2d6 (2d6) [[rules/conditions.md#Persistent%20Damage|persistent bleed damage]]."
