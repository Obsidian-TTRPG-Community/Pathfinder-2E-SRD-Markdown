...
abilities_bot:
  - name: "Blood Feast"
    desc: "⬻  Each enemy in the bat swarm's space takes 1d4 (1d4) piercing damage (DC 16 basic Reflex save). Creatures that fail this save also take 1 [[rules/conditions.md#Persistent%20Damage|persistent bleed damage]]."
