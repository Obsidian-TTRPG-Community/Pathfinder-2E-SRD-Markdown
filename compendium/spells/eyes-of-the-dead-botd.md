...
For the duration of the trance, your own senses are muted, though you can still communicate. This lack of awareness makes you [flat-footed](rules/conditions.md#Flat-footed). You can't take actions with the [attack](rules/traits/attack.md "Attack Combat Trait") or [move](rules/traits/move.md "Move Combat Trait") traits, nor can you cast spells.
