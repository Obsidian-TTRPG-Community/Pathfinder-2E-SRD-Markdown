...
- **Activate** envision; **Trigger** A creature within your reach uses a [manipulate](rules/traits/manipulate.md "Manipulate General Trait") or [move](rules/traits/move.md "Move Combat Trait") action, makes a ranged attack, or leaves a square during a move action it's using
