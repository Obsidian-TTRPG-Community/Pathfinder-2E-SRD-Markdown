...
The ammunition deals `1d4` [persistent poison damage](rules/conditions.md#Persistent%20Damage).

#### moderate *Item 5*

- **Price**: 25 gp

The ammunition deals `2d6` [persistent poison damage](rules/conditions.md#Persistent%20Damage).

#### greater *Item 11*

- **Price**: 250 gp

The ammunition deals `3d6` [persistent poison damage](rules/conditions.md#Persistent%20Damage).
