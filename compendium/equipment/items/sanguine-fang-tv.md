...
The resistance is 5 when affixed to armor, the [persistent bleed damage](rules/conditions.md#Persistent%20Damage) is `1d6` when affixed to a weapon, and the spell DC is 29.
...
The resistance is 10 and the item bonus is +3 when affixed to armor, the [persistent bleed damage](rules/conditions.md#Persistent%20Damage) is `2d6` when affixed to a weapon, and the spell DC is 34.
