...
The item bonus when affixed to armor is +2, and the spell DC is 27. On a critical hit with a weapon the doorknob is affixed to, the target is [blinded](rules/conditions.md#Blinded) until the end of its next turn.
...
The item bonus when affixed to armor is +2, and the spell DC is 34. On a critical hit with a weapon the doorknob is affixed to, the target is [blinded](rules/conditions.md#Blinded) until the end of its next turn.
