...
You can flip the central table over as a 3-action activity, which has the [manipulate](rules/traits/manipulate.md "Manipulate General Trait") trait, to revert the gaming hall to its original form.
```
