...
---
# Cold Comfort *Item 7+*  
[alchemical](rules/traits/alchemical.md "Alchemical Item Trait")  [cold](rules/traits/cold.md "Cold Energy & Element Trait")  [consumable](rules/traits/consumable.md "Consumable Item Trait")  [uncommon](rules/traits/uncommon.md "Uncommon Rarity Trait")  
...
Ice created by the pellets lasts for 1 hour or until [broken](rules/conditions.md#Broken).

#### greater *Item 15*

- **Price**: 1300 gp

The area increases to a 20-foot square, the save DC increases to 34, the cold damage increases to `4d6` and the [Escape](rules/actions/escape.md) DC increases to 31. Ice created by the pellets lasts for 3 hours or until [broken](rules/conditions.md#Broken). The block of ice is strong enough to support one [Huge](rules/traits/huge-b1.md "Huge Size Trait") creature, up to 2 [Large](rules/traits/large-b1.md "Large Size Trait") creatures, or up to 8 [Medium](rules/traits/medium-b1.md "Medium Size Trait") or [Small](rules/traits/small-b1.md "Small Size Trait") creatures.
