...
- **Activate** command; **Trigger** You attempt a saving throw against a [possession](rules/traits/possession.md "Possession Effect Trait") effect; **Requirements** You are a master in Will saves.
- **Category** Talisman
