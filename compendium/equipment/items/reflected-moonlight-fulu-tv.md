...
- **Activate** envision; **Trigger** You fail to save against a [negative](rules/traits/negative.md "Negative Energy & Element Trait") or [death](rules/traits/death.md "Death Effect Trait") effect.
