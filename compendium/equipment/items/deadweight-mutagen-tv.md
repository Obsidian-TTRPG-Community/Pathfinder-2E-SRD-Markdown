...
The bonus is +3, and the duration is 1 hour. You can attempt to [Shove](rules/actions/shove.md) or [Trip](rules/actions/trip.md) creatures up to two sizes larger than you.

#### major *Item 17*

- **Price**: 3000 gp

The bonus is +4, and the duration is 1 hour. You can attempt to [Shove](rules/actions/shove.md) or [Trip](rules/actions/trip.md) creatures up to three sizes larger than you.
