...
You split your attacks. Make two melee [Strikes](rules/actions/strike.md), one with each required weapon, each against a different foe. If the second [Strike](rules/actions/strike.md) is made with a non-[agile](rules/traits/agile.md "Agile Weapon Trait") weapon, it takes a –2 penalty.
