...
- **Trigger** A creature with the animal, beast, elemental, fey, [fungus](rules/traits/fungus-b1.md "Fungus Creature Type Trait"), or [plant](rules/traits/plant.md "Plant Creature Type Trait") trait attacks you, and you can see the attacker.
- **Activity** Reaction
