...
You can switch the fused item's form from a book to a shield with a book-shaped motif as a single action, which has the [concentrate](rules/traits/concentrate.md "Concentrate Action & Ability Trait") trait. When the item is in book form, you can read the book and [Raise the Tome](compendium/feats/raise-a-tome-som.md), and when it's in shield form, you can [Raise the Shield](rules/actions/raise-a-shield.md), [Activate it](rules/actions/activate-an-item.md), and gain any other benefits or effects the shield normally has (such as a spellguard shield's bonus to saving throws against magic). The fusion lasts until your next daily preparations.
