...
*Source: Extinction Curse #1: The Show Must Go On p. 75*  
%% #trait/archetype #trait/flourish #trait/uncommon %%
```  
...
*Source: Extinction Curse #1: The Show Must Go On p. 75*  
%% #trait/archetype #trait/press #trait/uncommon %%
```  
...
- **Requirements**: You are wielding your staff, which must have the [parry](rules/traits/parry.md "Parry Weapon Trait") trait.
- **Activity** Single Action
...
*Source: Extinction Curse #1: The Show Must Go On p. 75*  
%% #trait/archetype #trait/flourish #trait/stance #trait/uncommon %%
```  
...
*Source: Extinction Curse #1: The Show Must Go On p. 75*  
%% #trait/archetype #trait/attack #trait/open #trait/uncommon %%
```