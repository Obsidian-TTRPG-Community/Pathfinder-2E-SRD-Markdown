...
- **Arctic** For 1 hour, treat environmental [cold](rules/traits/cold.md "Cold Energy & Element Trait") effects as if they were one step less severe.
- **Desert** For 1 hour, treat environmental heat effects as if they were one step less severe.
- **Forest** Gain a +2 circumstance bonus to saves against [disease](rules/traits/disease.md "Disease Effect Trait") and [poison](rules/traits/poison.md "Poison Effect Trait") effects.
